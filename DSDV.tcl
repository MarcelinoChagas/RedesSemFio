...
set tracefd	    	[open testDSDV.tr w]
set windowVsTime2  	[open win.tr w]
set namtrace	    [open testDSDV.nam w]
...
# Gera o arquivo com o PDR gerado
    exec awk -f Packet_Delivery_Ratio.awk testDSDV.tr > outputDSDV_1_16.tr &
}
